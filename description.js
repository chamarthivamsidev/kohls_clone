...
function display(product){
    ...
    starDiv.setAttribute("id","star")
      ...
      prodImg.setAttribute("id","prodImg")
        ...
        colorDesc.innerHTML='<span style="color:#666;text-decoration:none">COLOR:</span> <span style="text-decoration:none;color:#222;font-weight:bold">ORANGE NAVY PLAID</span>'
       ...
       btnDiv.setAttribute("id","btnDiv")
        ...
        prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none">PLEASE CHOOSE A SIZE</span>'
        ...
        sizeBtn1.addEventListener("click",function(){
          ...
          prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none;font-weight:bold">S</span>'
        })
        ...
        sizeBtn2.textContent="M"
          ...
          prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none;font-weight:bold">M</span>'
        })
        ...
        sizeBtn3.textContent="L"
         ...
         sizeBtn3.addEventListener("click",function(){
          ...
          prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none;font-weight:bold">L</span>'
        })
        ...
        sizeBtn4.textContent="XL"
         sizeBtn4.addEventListener("click",function(){
          ...
          prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none;font-weight:bold">XL</span>'
        })
        ...
        sizeBtn5.textContent="XXL"
          ...
          prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none;font-weight:bold">XXL</span>'
        })
        ...
        sizeBtn6.textContent="XXXL"
          ...
          prodSize.innerHTML='<span style="color:#666;text-decoration:none">SIZE:</span> <span style="color:#222;black;text-decoration:none;font-weight:bold">XXXL</span>'
        })
      
        
       

        sizeBtnDiv.append(sizeBtn1,sizeBtn2,sizeBtn3,sizeBtn4,sizeBtn5,sizeBtn6)
    ...
    addListImg.setAttribute("src","desc Images/addlist.JPG")
      ...
      //   }
       ...
       addToCartBtn.append(addToCart)
        colorDiv.append(colorDesc,btnDiv,prodSize,sizeBtnDiv,sizeChart,quanDiv,addToCartBtn,addListDiv)
